...
var kuhong = db.get('ojan'); // jan diubah
	...
	console.log('XAVIOR-API!') // boleh diubah
}
...
var creator = 'XaviorOfc' // ubah jadi nama lu
const listkey = ["Alphabot","XaviorOfc","Zeeone","ZeeoneOfc"]; // ubah apikey nya, tambah aja klo mau
